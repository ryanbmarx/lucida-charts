...
export function initMap() {
    ...
    map.on("load", function () {
        ...
        mills.data.Mill.forEach(mill => {
            ...
            const rspoClass = mill.cert === "RSPO Certified" ? "pin--rspo" : "pin--non-rspo";
            console.log(mill.millName, mill.cert, mill.cert.toLowerCase().indexOf("not"));
            ...
            const marker = new mapboxgl.Marker(mapOptions).setPopup(popup).setLngLat(coordinates).addTo(map);
        });
    });
}
